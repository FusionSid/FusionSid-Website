        ...
        <div className="flex h-full">
            ...
            <div className="overflow-x-hidden ml-16 mt-12">
                ...
                <div className="whitespace-nowrap leading-[6rem] ml-10">
                    ...
                    <h3 className="text-black dark:text-white text-[3rem] font-poppinsbold inline-block">Hey! i'm</h3>
                ...
                <div className="whitespace-nowrap leading-[5rem] ml-9">
                    <h3 className="text-black dark:text-white text-[3rem] font-poppinsbold inline-block">aka</h3>
