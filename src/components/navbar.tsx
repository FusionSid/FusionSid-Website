            ...
            <nav className="w-full h-24 items-center justify-between flex py-6 border-b-[0.1px] border-opacity-10 border-white mb-3">
                <div className="h-24 items-center justify-between flex">
                    ...
                    <svg
                        ...
                        className="hover:animate-spin-slow ml-10 mr-2 flex gap-3 w-12 h-12 lg:w-14 lg:h-14"
                    >
                    ...
                    {ShowNavLogoText ?
                        <div className="flex">
                            <h3 className="inline-block px-1 mt-[0.45rem] text-[0.7rem] lg:text-[1rem] text-white opacity-10 font-jetbrains">/*</h3>
                            <Link className="font-jetbrains text-white text-[1.75rem] lg:text-[1.9rem] font-semibold inline-fold" to="/">FusionSid</Link>
                            <h3 className="inline-block px-1 mt-[1rem] text-[0.7rem] lg:text-[1rem] text-white opacity-10 font-jetbrains">*/</h3>
                        </div> : null
                    }
                </div>
                    ...
                    <ul className="flex flex-row mr-12 my-24 lg:gap-16 md:gap-8 justify-center">
                        {props.navlinks.map((navItem) => (
                            ...
                            >
                                ...
                                <Link
                                    className="md:text-[1rem] lg:text-[1.125rem] font-jetbrains inline-block text-white group-hover:text-pllblue"
                                    to={navItem.link}
                                >
                                    {navItem.title}
                                </Link>
                        ...
                        >
                            ...
                            <Link
                                className="text-pllblue md:text-[1rem] lg:text-[1.125rem] inline-block font-jetbrains group-hover:text-white"
                                to="/terminal"
                            >
                                Terminal
                            </Link>
