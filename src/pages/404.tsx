export default function NotFound404() {
	return (
		<div className="flex h-screen flex-col items-center border-b-[0.1px] border-black border-opacity-10 dark:border-white dark:border-opacity-10">
			<h1 className="text-xl dark:text-white">
				I don't know what to tell ya mate. This page simply just doesn't
				exist
			</h1>
			<h1 className="text-xl dark:text-white">
				The page may have gone to get the milk :(
			</h1>
			<svg className="h-[80vh] w-auto" viewBox="0 0 500 500">
